...
const Hero = () => {
  ...
  return (
    <>
      ...
      <section className="h-screen bg-cover bg-center bg-[url('/hero.png')]  bg-white">
        ...
        <div className="pt-24 md:pt-28 text-white md:w-1/2 mx-auto text-center p-2">
          ...
          <div className="relative inline-block z-30">
            <input
              ...
              className="border border-b-gray-300 focus:outline-none py-2 px-6 bg-white/15 rounded-full text-white/50 w-full mt-5"
            />
            {/* Search icon button */}
        ...
        {/* dark and light mood color switcher*/}
